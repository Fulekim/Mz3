...
// tartalmazza, amelyeknek az ára kevesebb, mint a paraméterben megadott szám!
    ...
    //2. Feladat
    function printCheaperThan(priceLimit, products) {
        const cheaperProducts = products.filter(product => product.price < priceLimit);
...
function getCheapestProduct(products) {
    const cheapestProduct = products.reduce((cheapest, currentProduct) => {
